...
«Опора» — это модульная платформа на едином технологическом ядре: от каталога верифицированных брендов до AI-кооперации, биржи креаторов, краудфандинга и экспортного «единого окна».
...
├── modules.md                # Все модули с описаниями
...
- [opora](https://github.com/AlexanderNarbaev/opora) — основной репозиторий платформы (современный Java-стек)

...
«Опора» — это 20 модулей (13+7) на едином технологическом ядре: от каталога верифицированных брендов до AI-кооперации, биржи креаторов, краудфандинга и экспортного «единого окна».
...
├── modules.md                # Все 20 модулей с описаниями

...
layout: default
title: Модули
description: 20 модулей платформы «Опора» — от Витрины до Экспорта. Каждый модуль закрывает конкретную потребность бизнеса и гражданина.
---

<section class="section">
  <div class="container">
    <h1 class="section-title">20 модулей платформы «Опора»</h1>
    <p class="section-subtitle">
      13 бизнес-модулей и 7 инфраструктурных сервисов.

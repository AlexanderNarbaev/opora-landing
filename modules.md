...
layout: default
title: Модули
description: Модули платформы «Опора» — от Витрины до Экспорта. Каждый модуль закрывает конкретную потребность бизнеса и гражданина.
---

<section class="section">
  <div class="container">
    <h1 class="section-title">Модули платформы «Опора»</h1>
    <p class="section-subtitle">
      бизнес-модули и инфраструктурные сервисы.
